...
import { TaxonomyEditor, DialogTaxonomyInput } from '@oarepo/quasar-taxonomy-editor'
import TestViewComponent from 'src/components/TestViewComponent'
import TestEditComponent from 'src/components/TestEditComponent'
...
class App extends Vue {
    ...
    mounted () {
        this.$taxonomies.loadTaxonomies('/api/2.0/taxonomies/').then(taxonomies => {
